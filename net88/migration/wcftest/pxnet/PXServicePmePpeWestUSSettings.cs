// <copyright file="PXServicePmePpeWestUSSettings.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmePpeWestUSSettings : PXServiceProdSettings
    {
        ...
        public PXServicePmePpeWestUSSettings() : base()
        {
            ...
            this.PIMSAccessor = new PIMSAccessor(
                ...
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-westus.azurewebsites.net",
            ...
            this.CatalogServiceAccessor = new CatalogServiceAccessor(
                serviceBaseUrl: "https://px-pxdependencyemulators-ppe-westus.azurewebsites.net",
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-westus.azurewebsites.net",
