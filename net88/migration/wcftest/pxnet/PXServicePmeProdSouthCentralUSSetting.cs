// <copyright file="PXServicePmeProdSouthCentralUSSetting.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmeProdSouthCentralUSSetting : PXServiceProdSettings
    {
        ...
        public PXServicePmeProdSouthCentralUSSetting() : base()
        {
            this.PIMSAccessor = new PIMSAccessor(
                serviceBaseUrl: this.PimsBaseUrl,
                emulatorBaseUrl: "https://px-pxdependencyemulators-prod-southcentralus.azurewebsites.net",
            ...
            this.PaymentOrchestratorServiceAccessor = new PaymentOrchestratorServiceAccessor(
                serviceBaseUrl: "https://app-payorch-payorch-prod-wcus-1.azurewebsites.net",
                emulatorBaseUrl: "tbd",
                apiVersion: "1.1",
