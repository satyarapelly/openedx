// <copyright file="PimsSessionException.cs" company="Microsoft">Copyright (c) Microsoft. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService
{
    ...
    /// </summary>
    [Serializable]
    public class PimsSessionException : Exception
    {
        private const string ServiceErrorCodeName = "Error";
        
        public PimsSessionException(ServiceErrorResponse error)
            : base(error?.Message)
        {
            this.Error = error;
