## TSG - PX Traffic Drop - Multiple flows
__PX Traffic Drop - Multiple Flows__

* __Background__:  This TSG is for investigating the traffic drop of multiple operation names .The issue involves a significant drop in traffic across multiple flows, impacting the PX service.

* __Issue__: After get an IcM generated by PX Traffic Drop - Multiple flows monitors, always start your investigation from IcM itself. Use [Incident-598687964](https://portal.microsofticm.com/imp/v5/incidents/details/598687964/summary)  Details - IcM  as an sample.
...
* __Steps to Investigate__:
    ...
    3. __Modify Operation Name & Time__: Adjust the operation name and time based on the impacted operations and time window.
        ...
        * __PaymentMethodDescriptionsController-GET__ , 
        * __PaymentInstrumentsExController-POST__,
        * __PaymentInstrumentsExController-POST-UpdateModernPI__,
        * __PaymentInstrumentsExController-GET__,
        * __PaymentInstrumentsExController-GET-GetModernPI__, 
        * __PaymentInstrumentsExController-POST-RemoveModernPI__, 
        * __PaymentSessionsController-POST-PostPaymentSession__, 
        * __PaymentSessionDescriptionsController-GET__,
        * __PaymentSessionsController-POST-CreateAndAuthenticate__,
        * __ChallengeDescriptionsController-GET__,
        * __PaymentSessionsController-POST-Authenticate__,
        * __PaymentSessionsController-POST-BrowserAuthenticate__,
        * __PaymentSessionsController-GET-AuthenticationStatus__,
        * __PaymentSessionsController-POST-NotifyThreeDSChallengeCompleted__
    
* __Sample Query__
    ```
    custer("pst").database("Prod").RequestTelemetry
    ...
    | where TIMESTAMP between (datetime(2025-02-20 15:45:52Z) .. datetime(2025-02-20 17:55:52Z))
 ...
 * __Run the below query to check the system errors and user errors__
    ...
    ``` 
    let startTime = datetime(2025-02-20 16:45:52Z);  //ICM Troubleshooting Information
    let endTime = datetime(2025-02-20 16:55:52Z);
...
* __Run the below query to check the exact error.__
     ...
     ```
    RequestTelemetry
    |where TIMESTAMP  between (datetime(2025-02-24 04:51:06Z) .. datetime(2025-02-24 05:01:06Z))
    ...
    | where data_baseData_operationName == "PaymentSessionsController-POST-Authenticate"
