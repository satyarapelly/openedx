...
namespace Marketplace.Web.PayModClient
{
    ...
    public class SnakeCasingJsonContractResolver : DefaultContractResolver
    {
        ...
        protected override JsonDictionaryContract CreateDictionaryContract(Type objectType)
        {
            ...
            {
                // Newtonsoft.Json 6.0.8 -> 11.0.2 package upgrade contract break change. PropertyNameResolver changed to DictionaryKeyResolver.
        ...
        private class EnumConverter : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
            {
                ...
                if (reader.TokenType == JsonToken.String)
                {
                    return Enum.Parse(objectType, ToPascalCase(reader.Value.ToString()), true);
                }
            ...
            public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
            {
                if (value != null)
                {
                    writer.WriteValue(ToJsonCase(value.ToString()));
                }
            }
        }
    }
