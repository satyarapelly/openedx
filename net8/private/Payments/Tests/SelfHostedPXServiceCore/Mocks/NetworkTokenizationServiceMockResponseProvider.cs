...
namespace SelfHostedPXServiceCore.Mocks
{
    ...
    public class NetworkTokenizationServiceMockResponseProvider : IMockResponseProvider
    {
        ...
        public async Task<HttpResponseMessage> GetMatchedMockResponse(HttpRequestMessage request)
        {
            ...
            {
                response = "{\"status\":\"challenge\",\"challengeId\":\"c6f4cba0-2c09-4e4c-a6cf-20b3a17ff0dd\",\"challengeMethods\":[{\"challengeMethodType\":\"otpSms\",\"challengeValue\":\"******8080\",\"challengeMethodId\":\"Zjg5YjY2NjhlMzU3ZjdkN2UzZDQxZmRkZmE1NDU2MDI=\"},{\"challengeMethodType\":\"otpEmail\",\"challengeValue\":\"R************N@GMAIL.COM\",\"challengeMethodId\":\"YTdiZGM4NGM4ZWYwMjkyZjhiMDExZWQ5MWY3NTE3MDI=\"},{\"challengeMethodType\":\"OutboundCall\",\"challengeValue\":\"test123\",\"challengeMethodId\":\"ZWY2NTkyZDFiNjZlZTMwZGQyNjg1ZDY3NDY0YTc1MDE=\"}]}";
            }            
