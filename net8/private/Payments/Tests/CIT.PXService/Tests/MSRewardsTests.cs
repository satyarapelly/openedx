...
namespace CIT.PXService.Tests
{
    ...
    public class MSRewardsTests : TestBase
    {
        ...
        public async Task RedeemRewards_XboxNative_NoChallenge_Success(int redeemResultcode, string redeemStatus, string partner)
        {
            ...
            PXFlightHandler.AddToEnabledFlights("PXOverrideHasAnyPIToTrue,PXEnableXboxNativeRewards,PXShowRewardsErrorPage");
        ...
        [DataRow(2010, "E_RISK_FAILURE", true, true)]
        [DataRow(2010, "E_RISK_FAILURE", true, false)]
        [DataRow(2010, "E_RISK_FAILURE", false, true)]
        [DataRow(2010, "E_RISK_FAILURE", false, false)]
        [DataRow(2042, "E_EXISTING_RISK_REVIEW", true, false)]
        [DataRow(2042, "E_EXISTING_RISK_REVIEW", true, true)]
        [DataRow(2042, "E_EXISTING_RISK_REVIEW", false, true)]
        [DataRow(2042, "E_EXISTING_RISK_REVIEW", false, false)]
        [DataRow(2007, "E_CHALLENGE_FIRST", true, true)]
        [DataRow(2007, "E_CHALLENGE_FIRST", true, false)]
        [DataRow(2007, "E_CHALLENGE_FIRST", false, true)]
        [DataRow(2007, "E_CHALLENGE_FIRST", false, false)]
        [DataRow(2008, "E_SOLVE_FIRST", true, true)]
        [DataRow(2008, "E_SOLVE_FIRST", true, false)]
        [DataRow(2008, "E_SOLVE_FIRST", false, true)]
        [DataRow(2008, "E_SOLVE_FIRST", false, false)]
        [TestMethod]
        public async Task RedeemRewards_XboxNative_FailureWithErrorCode(int errorCode, string errorCodeName, bool isVariableAmount, bool styleHintsFlight)
        {
            // Arrange
            string userPuid = "844426234689219";
            string deviceId = "1234567890";
            ...
            string flights = "PXOverrideHasAnyPIToTrue,PXEnableXboxNativeRewards,PXShowRewardsErrorPage";
            if (styleHintsFlight)
            {
                flights += ",PXEnableXboxNativeStyleHints";
            }
            ...
            if (result.Content != null)
            {
                ...
                if (styleHintsFlight)
                {
                    Assert.IsTrue(msRewardsErrorPage.StyleHints.Count > 0);
                    Assert.IsTrue(msRewardsErrorPage.StyleHints.SequenceEqual(new List<string> { "height-fill" }));
                }
                else
                {
                    Assert.IsNull(msRewardsErrorPage.StyleHints);
                }
        ...
        [DataRow(2003, "E_INVALID_SKU", true, false)]
        [DataRow(2003, "E_INVALID_SKU", true, true)]
        [TestMethod]
        public async Task RedeemRewards_XboxNative_FailureWithErrorCode_invalidSku(int errorCode, string errorCodeName, bool isVariableAmount, bool styleHintsFlight)
        {
            // Arrange
            string userPuid = "844426234689219";
            string deviceId = "1234567890";
            ...
            var rewardsServiceResponse = new
            {
                response = new
                {
                    result_message = "This sku does not support variable item 000400000253",
                    order = (object)null,
                    msa_phone_number = (object)null,
                    chg_details = (object)null
                },
                correlationId = "t7Q1FkB+mc5tkXhu.2.2.2",
                code = errorCode
            };
            ...
            PXSettings.MSRewardsService.ArrangeResponse(JsonConvert.SerializeObject(rewardsServiceResponse), HttpStatusCode.BadRequest, HttpMethod.Post);
            ...
            if (result.Content != null)
            {
                ...
                JObject contextData = JObject.Parse(gotItButton.Action.Context.ToString());
                JObject instance = JObject.Parse(contextData["instance"].ToString());
                Assert.AreEqual("E_REWARDS_GENERIC_ERROR", instance["errorCode"].ToString());
                Assert.AreEqual(status, instance["status"].ToString());
                Assert.AreEqual("Failed to redeem rewards. Please try again later.", instance["errorMessage"].ToString());
            }
        ...
        [DataRow(true, true)]
        [TestMethod]
        public async Task RedeemRewards_XboxNative_FailureWithErrorCode_invalidResponse(bool isVariableAmount, bool styleHintsFlight)
        {
            // Arrange
            string userPuid = "844426234689219";
            string deviceId = "1234567890";
            ...
            // Send invalid JSON that will cause deserialization to fail
            string rewardsServiceResponse = "{ invalid_json: []]]}";
            ...
            // Don't serialize the response since it's already a string and we want it to be invalid JSON
            PXSettings.MSRewardsService.ArrangeResponse(rewardsServiceResponse, HttpStatusCode.BadRequest, HttpMethod.Post);
        ...
        [DataRow(true, true)]
        [TestMethod]
        public async Task RedeemRewards_XboxNative_RewardsFailure(bool isVariableAmount, bool styleHintsFlight)
        {
            // Arrange
            string userPuid = "844426234689219";
            string deviceId = "1234567890";
        ...
        [TestMethod]
        public async Task RedeemRewards_Failure()
        {
            // Arrange
            string userPuid = "844426234689219";
            string deviceId = "1234567890";
