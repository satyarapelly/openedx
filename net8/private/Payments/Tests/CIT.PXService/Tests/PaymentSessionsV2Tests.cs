...
namespace CIT.PXService.Tests
{
    ...
    using PaymentSessionRequest = Microsoft.Commerce.Payments.PXService.Model.PayerAuthService.PaymentSessionRequest;
    using Microsoft.Commerce.Payments.PXService.Model.ThreeDSExternalService;
    using static PXService.GlobalConstants;

    [TestClass]
    public class PaymentSessionsV2Tests : TestBase
    {
        ...
        {
            // Set flights
            PXFlightHandler.AddToEnabledFlights("PXPSD2ProdIntegration,PXUsePaymentSessionsHandlerV2");
        }
        ...
        [DataRow(false, false)]
        [TestMethod]
        public async Task ChallengeDescriptions_SkipsChallengeForURL(bool skipFingerprint, bool skipChallenge)
        {
            // Arrange
            PXSettings.PimsService.ResponseProvider.RequiredChallenges = new List<string>() { "3ds2" };

            PXSettings.PayerAuthService.ResponseProvider.ThreeDSMethodUrl = "https://acs.test.com";
            ...
            {
                PXFlightHandler.AddToEnabledFlights("PXPSD2SkipFingerprintByUrl");
                PXFlightHandler.AddToEnabledFlights("PXPSD2SkipUrl_acstestcom");
            }

            if (skipChallenge)
            {
                PXFlightHandler.AddToEnabledFlights("PXPSD2SkipChallengeByUrl");
                PXFlightHandler.AddToEnabledFlights("PXPSD2SkipChallengeUrl_acstestcom");
            }
            ...
            {
                PaymentSession paymentSession = JsonConvert.DeserializeObject<PaymentSession>(pidl[0].ClientAction.Context.ToString());
                Assert.AreEqual(ClientActionType.ReturnContext, pidl[0].ClientAction.ActionType);
                Assert.IsNotNull(pidl[0].ClientAction.Context);
                Assert.IsTrue(paymentSession.ChallengeStatus == PaymentChallengeStatus.Succeeded);
            }
        }
        ...
        /// <summary>
        /// Validate payer auth called with right device channel
        /// </summary>
        [TestMethod]
        [DataRow(DeviceChannel.Browser)]
        [DataRow(DeviceChannel.AppBased)]
        public async Task PaymentSessionDescriptions_PayerAuthDeviceChannel_PostCreateSession(DeviceChannel expectedDeviceChannel)
        {
            if (expectedDeviceChannel == DeviceChannel.Browser)
            {
                PXFlightHandler.AddToEnabledFlights("PXEnableBrowserBasedDeviceChannel");
            }
            ...
            // setting it to a type we don't care about for tests
            DeviceChannel deviceChannel = DeviceChannel.ThreeDSRequestorInit;
            PXSettings.PayerAuthService.PreProcess = async (payerAuthRequest) =>
            {
                if (string.Equals(payerAuthRequest.RequestUri.AbsolutePath, "/CreatePaymentSessionId"))
                {
                    string requestContent = await payerAuthRequest.Content.ReadAsStringAsync();
                    PaymentSessionRequest sessionData = JsonConvert.DeserializeObject<PaymentSessionRequest>(requestContent);
                    deviceChannel = sessionData.PaymentSessionData.DeviceChannel;
                }
            };
            ...
            // Assert
            Assert.AreEqual(HttpStatusCode.OK, pxResponse.StatusCode);
            Assert.AreEqual(deviceChannel, expectedDeviceChannel, "DeviceChannel not expected");
        ...
        [DataRow("setupofficesdx", false)]
        public async Task PaymentSessions_BrowserAuthenticate_IsGuestCheckout(string partner, bool isGuestCheckoutSession)
        {
            // Arrange
            bool preProcessAssertCalled = false;
            string paymentSessionId = "ZFFFFFFFFFFF78a93cbb-8a57-49d9-84b7-42c5f042dba6";
            string payAuthResp = "{\"enrollment_status\":\"bypassed\",\"enrollment_type\":\"three_ds\",\"three_ds_server_transaction_id\":\"f35eadb1-6517-433d-af58-a28a0150a19d\",\"acs_url\":\"https://payments-acs-emulator-fzeug0g7atchf8d7.b02.azurefd.net/payments/ve1_2/challenge\",\"acs_signed_content\":\"{\\\"MD\\\":\\\"A4560000307199\\\",\\\"PaReq\\\":\\\"eyJhdXRoZW50aWNhdGlvbmlkIjoiZjM1ZWFkYjEtNjUxNy00MzNkLWFmNTgtYTI4YTAxNTBhMTlkIn0=\\\",\\\"TermUrl\\\":\\\"https://www.merchanturl.com/Response.jsp\\\"}\",\"authenticate_update_url\":\"/bd888d21-f2a9-4f8b-92c2-129b8d4748b6/payments/Z10009BHVVL2e8a44f83-dc56-4689-8c5d-4a7fc003c8f1/authenticate\",\"transaction_challenge_status\":\"C\",\"is_form_post_acs_url\":true,\"is_full_page_redirect\":true}";
            string sessionResp = "{\"id\":\"" + paymentSessionId + "\",\"session_type\":\"any\",\"Data\":\"{\\\"isGuestCheckout\\\":\\\"" + isGuestCheckoutSession.ToString().ToLower() + "\\\",\\\"ExposedFlightFeatures\\\":[\\\"PXPSD2Auth-_-_-Succeeded\\\",\\\"PXPSD2Auth-C-_-Unknown\\\",\\\"PXPSD2Auth-N-TSR10-Failed\\\",\\\"PXPSD2Auth-R-_-Failed\\\",\\\"PXPSD2Comp-_-_-_-Succeeded\\\",\\\"PXPSD2Comp-_-_-01-Cancelled\\\",\\\"PXPSD2Comp-N-_-04-TimedOut\\\",\\\"PXPSD2Comp-N-TSR10-_-Failed\\\",\\\"PXPSD2Comp-R-_-_-Failed\\\",\\\"PXPSD2SettingVersionV19\\\"],\\\"PayerAuthApiVersion\\\":\\\"2019-04-16\\\",\\\"AccountId\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"BrowserInfo\\\":{\\\"browser_accept_header\\\":\\\"*/*\\\",\\\"browser_ip\\\":\\\"::1\\\",\\\"browser_java_enabled\\\":true,\\\"browser_language\\\":\\\"en-US\\\",\\\"browser_color_depth\\\":\\\"8\\\",\\\"browser_screen_height\\\":\\\"480\\\",\\\"browser_screen_width\\\":\\\"640\\\",\\\"browser_tz\\\":\\\"480\\\",\\\"browser_user_agent\\\":\\\"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36\\\",\\\"challenge_window_size\\\":\\\"05\\\"},\\\"MethodData\\\":{\\\"three_ds_server_trans_id\\\":\\\"123\\\",\\\"three_ds_method_url\\\":\\\"https://testurl.com\\\"},\\\"AuthenticationResponse\\\":{\\\"enrollment_status\\\":\\\"bypassed\\\",\\\"enrollment_type\\\":\\\"three_ds\\\",\\\"three_ds_server_transaction_id\\\":\\\"73f512ef-48fb-4322-b87d-ce6a3622ef1b\\\",\\\"acs_url\\\":\\\"https://payments-acs-emulator-fzeug0g7atchf8d7.b02.azurefd.net/payments/ve1_2/challenge\\\",\\\"acs_transaction_id\\\":null,\\\"authenticate_update_url\\\":\\\"/bd888d21-f2a9-4f8b-92c2-129b8d4748b6/payments/Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec/authenticate\\\",\\\"acs_signed_content\\\":\\\"{\\\\\\\"MD\\\\\\\":\\\\\\\"A4560000307199\\\\\\\",\\\\\\\"PaReq\\\\\\\":\\\\\\\"eyJhdXRoZW50aWNhdGlvbmlkIjoiNzNmNTEyZWYtNDhmYi00MzIyLWI4N2QtY2U2YTM2MjJlZjFiIn0=\\\\\\\",\\\\\\\"TermUrl\\\\\\\":\\\\\\\"https://www.merchanturl.com/Response.jsp\\\\\\\"}\\\",\\\"transaction_challenge_status\\\":\\\"C\\\",\\\"transaction_challenge_status_reason\\\":\\\"01\\\",\\\"card_holder_info\\\":null,\\\"acs_rendering_type\\\":null,\\\"acs_challenge_mandated\\\":null,\\\"acs_operator_id\\\":null,\\\"acs_reference_number\\\":null,\\\"authentication_type\\\":null,\\\"ds_reference_number\\\":null,\\\"is_form_post_acs_url\\\":true,\\\"is_full_page_redirect\\\":true},\\\"billableAccountId\\\":null,\\\"classicProduct\\\":null,\\\"EmailAddress\\\":null,\\\"Language\\\":\\\"en-US\\\",\\\"SuccessUrl\\\":null,\\\"FailureUrl\\\":null,\\\"ChallengeStatus\\\":\\\"Unknown\\\",\\\"payment_session_id\\\":\\\"Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec\\\",\\\"account_id\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"caid\\\":null,\\\"payment_instrument_id\\\":\\\"9MEvEAAAAAAEAACA\\\",\\\"partner\\\":\\\"" + partner + "\\\",\\\"amount\\\":100.0,\\\"currency\\\":\\\"INR\\\",\\\"country\\\":\\\"IN\\\",\\\"has_pre_order\\\":false,\\\"is_legacy\\\":false,\\\"is_moto\\\":false,\\\"three_dsecure_scenario\\\":\\\"PaymentTransaction\\\",\\\"payment_method_family\\\":\\\"credit_card\\\",\\\"payment_method_type\\\":\\\"visa\\\",\\\"device_channel\\\":\\\"browser\\\",\\\"is_challenge_required\\\":true,\\\"purchaseOrderId\\\":null,\\\"cvv_token \\\":null}\",\"encrypt_data\":false,\"state\":\"INCOMPLETE\",\"test_context\":{\"scenarios\":\"px-service-billdesk-provider,px-service-psd2-e2e-emulator,px-service-3ds1-show-iframe\",\"contact\":\"kowshikp\",\"context_props\":{}}}";
            PXSettings.SessionService.ResponseProvider.SessionStore.Add(paymentSessionId, sessionResp);
            PXSettings.PayerAuthService.ArrangeResponse(
                method: HttpMethod.Post,
                urlPattern: ".*/Authenticate.*",
            ...
            PXSettings.PayerAuthService.PreProcess = async (payerAuthRequest) =>
            {
                string requestContent = await payerAuthRequest.Content.ReadAsStringAsync();
                JObject jsonObj = JObject.Parse(requestContent);
                string riskChallengeIndicator = jsonObj.SelectToken("risk_challenge_indicator").ToString();

                if (isGuestCheckoutSession)
                {
                    Assert.AreEqual("challenge_requested_preference", riskChallengeIndicator);
                }
                else
                {
                    Assert.AreEqual("no_preference", riskChallengeIndicator);
                }
            ...
            Assert.IsTrue(preProcessAssertCalled, "PreProcess is not called.");
        ...
        [TestMethod]
        [DataRow("cart", "cr_123", true)]
        [DataRow("cart", "pr_123", true)]
        [DataRow("cart", null, true)]
        [DataRow("cart", "cr_123", false)]
        [DataRow("cart", "pr_123", false)]
        [DataRow("cart", null, false)]
        public async Task PaymentSessions_BrowserAuthenticate_CheckoutPSD2(string partner, string requestId, bool requestContextHeaderIsFromPIFD)
        {
            // Arrange
            bool poAttachChallengeDataAPIisCalled = false;
            string paymentSessionId = "ZFFFFFFFFFFF78a93cbb-8a57-49d9-84b7-42c5f042dba6";
            string sessionResp = "{\"id\":\"" + paymentSessionId + "\",\"session_type\":\"any\",\"Data\":\"{\\\"requestId\\\":\\\"" + requestId + "\\\",\\\"tenantId\\\":\\\"tenantIdFromSession\\\",\\\"ExposedFlightFeatures\\\":[\\\"PXPSD2Auth-_-_-Succeeded\\\",\\\"PXPSD2Auth-C-_-Unknown\\\",\\\"PXPSD2Auth-N-TSR10-Failed\\\",\\\"PXPSD2Auth-R-_-Failed\\\",\\\"PXPSD2Comp-_-_-_-Succeeded\\\",\\\"PXPSD2Comp-_-_-01-Cancelled\\\",\\\"PXPSD2Comp-N-_-04-TimedOut\\\",\\\"PXPSD2Comp-N-TSR10-_-Failed\\\",\\\"PXPSD2Comp-R-_-_-Failed\\\",\\\"PXPSD2SettingVersionV19\\\"],\\\"PayerAuthApiVersion\\\":\\\"2019-04-16\\\",\\\"AccountId\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"BrowserInfo\\\":{\\\"browser_accept_header\\\":\\\"*/*\\\",\\\"browser_ip\\\":\\\"::1\\\",\\\"browser_java_enabled\\\":true,\\\"browser_language\\\":\\\"en-US\\\",\\\"browser_color_depth\\\":\\\"8\\\",\\\"browser_screen_height\\\":\\\"480\\\",\\\"browser_screen_width\\\":\\\"640\\\",\\\"browser_tz\\\":\\\"480\\\",\\\"browser_user_agent\\\":\\\"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36\\\",\\\"challenge_window_size\\\":\\\"05\\\"},\\\"MethodData\\\":{\\\"three_ds_server_trans_id\\\":\\\"123\\\",\\\"three_ds_method_url\\\":\\\"https://testurl.com\\\"},\\\"AuthenticationResponse\\\":{\\\"enrollment_status\\\":\\\"bypassed\\\",\\\"enrollment_type\\\":\\\"three_ds\\\",\\\"three_ds_server_transaction_id\\\":\\\"73f512ef-48fb-4322-b87d-ce6a3622ef1b\\\",\\\"acs_url\\\":\\\"https://payments-acs-emulator-fzeug0g7atchf8d7.b02.azurefd.net/payments/ve1_2/challenge\\\",\\\"acs_transaction_id\\\":null,\\\"authenticate_update_url\\\":\\\"/bd888d21-f2a9-4f8b-92c2-129b8d4748b6/payments/Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec/authenticate\\\",\\\"acs_signed_content\\\":\\\"{\\\\\\\"MD\\\\\\\":\\\\\\\"A4560000307199\\\\\\\",\\\\\\\"PaReq\\\\\\\":\\\\\\\"eyJhdXRoZW50aWNhdGlvbmlkIjoiNzNmNTEyZWYtNDhmYi00MzIyLWI4N2QtY2U2YTM2MjJlZjFiIn0=\\\\\\\",\\\\\\\"TermUrl\\\\\\\":\\\\\\\"https://www.merchanturl.com/Response.jsp\\\\\\\"}\\\",\\\"transaction_challenge_status\\\":\\\"C\\\",\\\"transaction_challenge_status_reason\\\":\\\"01\\\",\\\"card_holder_info\\\":null,\\\"acs_rendering_type\\\":null,\\\"acs_challenge_mandated\\\":null,\\\"acs_operator_id\\\":null,\\\"acs_reference_number\\\":null,\\\"authentication_type\\\":null,\\\"ds_reference_number\\\":null,\\\"is_form_post_acs_url\\\":true,\\\"is_full_page_redirect\\\":true},\\\"billableAccountId\\\":null,\\\"classicProduct\\\":null,\\\"EmailAddress\\\":null,\\\"Language\\\":\\\"en-US\\\",\\\"SuccessUrl\\\":null,\\\"FailureUrl\\\":null,\\\"ChallengeStatus\\\":\\\"Unknown\\\",\\\"payment_session_id\\\":\\\"Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec\\\",\\\"account_id\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"caid\\\":null,\\\"payment_instrument_id\\\":\\\"9MEvEAAAAAAEAACA\\\",\\\"partner\\\":\\\"" + partner + "\\\",\\\"amount\\\":100.0,\\\"currency\\\":\\\"INR\\\",\\\"country\\\":\\\"IN\\\",\\\"has_pre_order\\\":false,\\\"is_legacy\\\":false,\\\"is_moto\\\":false,\\\"three_dsecure_scenario\\\":\\\"PaymentTransaction\\\",\\\"payment_method_family\\\":\\\"credit_card\\\",\\\"payment_method_type\\\":\\\"visa\\\",\\\"device_channel\\\":\\\"browser\\\",\\\"is_challenge_required\\\":true,\\\"purchaseOrderId\\\":null,\\\"cvv_token \\\":null}\",\"encrypt_data\":false,\"state\":\"INCOMPLETE\",\"test_context\":{\"scenarios\":\"px-service-billdesk-provider,px-service-psd2-e2e-emulator,px-service-3ds1-show-iframe\",\"contact\":\"kowshikp\",\"context_props\":{}}}";
            string attachChallengeDataResponse = null;
            if (requestId == "pr_123") 
            {
                attachChallengeDataResponse = "{\"paymentRequestId\":\"pr_5032b4b0719e4a9d8c813d6f081b9c39\",\"status\":\"PendingInitialTransaction\",\"country\":\"us\",\"currency\":\"USD\",\"language\":\"en-us\",\"paymentInstruments\":[{\"paymentInstrumentId\":\"bb46726e-e9e1-4d48-bb1d-2bd42bdd1dd4\",\"usage\":\"PrimaryPaymentInstrument\",\"enforcePaymentChallenge\":true,\"paymentMethodType\":\"Visa\"}],\"amount\":1.0,\"moto\":null,\"preOrder\":null,\"clientActions\":[{\"type\":1,\"challengeType\":\"ThreeDs2\",\"paymentInstrument\":{\"paymentInstrumentId\":\"bb46726e-e9e1-4d48-bb1d-2bd42bdd1dd4\",\"usage\":\"PrimaryPaymentInstrument\",\"enforcePaymentChallenge\":true,\"paymentMethodType\":\"Visa\"}}]}";
            }
            else if (requestId == "cr_123")
            {
                attachChallengeDataResponse = "{\"checkoutRequestId\":\"pr_5032b4b0719e4a9d8c813d6f081b9c39\",\"paymentRequestId\":\"pr_6b4d84a2208f492c90273890853ecf37\",\"checkoutStatus\":\"PendingInitialTransaction\",\"country\":\"us\",\"currency\":\"USD\",\"language\":\"en-us\",\"paymentInstruments\":[{\"paymentInstrumentId\":\"bb46726e-e9e1-4d48-bb1d-2bd42bdd1dd4\",\"usage\":\"PrimaryPaymentInstrument\",\"enforcePaymentChallenge\":true,\"paymentMethodType\":\"Visa\"}],\"amount\":1.0,\"preOrder\":null,\"clientActions\":[{\"type\":1,\"challengeType\":\"ThreeDs2\",\"paymentInstrument\":{\"paymentInstrumentId\":\"bb46726e-e9e1-4d48-bb1d-2bd42bdd1dd4\",\"usage\":\"PrimaryPaymentInstrument\",\"enforcePaymentChallenge\":true,\"paymentMethodType\":\"Visa\"}}]}";
            }
            
            PXSettings.SessionService.ResponseProvider.SessionStore.Add(paymentSessionId, sessionResp);
            PXSettings.PaymentOrchestratorService.ArrangeResponse(attachChallengeDataResponse);
            ...
            bool requestContextHeaderisSentWithTenantId = false;
            PXSettings.PaymentOrchestratorService.PreProcess = (poRequestData) =>
            {
                poAttachChallengeDataAPIisCalled = poRequestData.RequestUri.AbsolutePath.Contains("attachChallengeData");
                requestContextHeaderisSentWithTenantId = poRequestData.Headers.Contains("x-ms-request-context");
                if (requestContextHeaderIsFromPIFD)
                {
                    requestContextHeaderisSentWithTenantId = poRequestData.Headers.GetValues("x-ms-request-context").FirstOrDefault().Contains("tenantIdFromPIFD");
                }
                else
                {
                    requestContextHeaderisSentWithTenantId = poRequestData.Headers.GetValues("x-ms-request-context").FirstOrDefault().Contains("tenantIdFromSession");
                }
            };
            ...
            if (requestContextHeaderIsFromPIFD)
            {
                request.Headers.Add("x-ms-request-context", "{\"tenantId\":\"tenantIdFromPIFD\"}");
            }
            ...
            Assert.IsNotNull(responseBody);
            Assert.IsTrue(poAttachChallengeDataAPIisCalled == !string.IsNullOrEmpty(requestId), "PreProcess is not called.");
            if (requestId == "pr_123")
            {
                Assert.IsTrue(responseBody.Contains("Status\\\""), "responsebody is" + responseBody);
            }
            else if (requestId == "cr_123")
            {
                Assert.IsTrue(responseBody.Contains("CheckoutStatus\\\""), "responsebody is" + responseBody);
            }

            Assert.IsTrue(requestContextHeaderisSentWithTenantId == !string.IsNullOrEmpty(requestId), "RequestContext header with tenant id is not sent");

            PXSettings.SessionService.ResetToDefaults();
            PXSettings.PayerAuthService.ResetToDefaults();
            PXSettings.PaymentOrchestratorService.ResetToDefaults();
            PXSettings.PaymentOrchestratorService.Responses.Clear();
        }

        [TestMethod]
        [DataRow("cart", "cr_123", "0", false, true, false)]
        [DataRow("cart", null, "0", false, false, true)]
        [DataRow("cart", "cr_123", "100", true, true, false)]
        [DataRow("cart", null, "100", true, false, true)]
        [DataRow("cart", "cr_123", "0", true, true, false)]
        [DataRow("cart", null, "0", true, false, true)]
        [DataRow("cart", "cr_123", "100", false, true, false)]
        [DataRow("cart", null, "100", false, false, false)]
        public async Task PaymentSessions_BrowserAuthenticate_CheckoutPSD2_SkipValidatePI(string partner, string requestId, string amount, bool isPreOrder, bool isPaaSflow, bool shouldDoValidatePI)
        {
            // Arrange
            bool poAttachChallengeDataAPIisCalled = false;
            bool pimsValidateChallengeDataAPIisCalled = false;
            bool pimsLinkTransactionAPIisCalled = false;
            string paymentSessionId = "ZFFFFFFFFFFF78a93cbb-8a57-49d9-84b7-42c5f042dba6";
            string sessionResp = "{\"id\":\"" + paymentSessionId + "\",\"session_type\":\"any\",\"Data\":\"{\\\"requestId\\\":\\\"" + requestId + "\\\",\\\"ExposedFlightFeatures\\\":[\\\"PXPSD2Auth-_-_-Succeeded\\\",\\\"PXPSD2Auth-C-_-Unknown\\\",\\\"PXPSD2Auth-N-TSR10-Failed\\\",\\\"PXPSD2Auth-R-_-Failed\\\",\\\"PXPSD2Comp-_-_-_-Succeeded\\\",\\\"PXPSD2Comp-_-_-01-Cancelled\\\",\\\"PXPSD2Comp-N-_-04-TimedOut\\\",\\\"PXPSD2Comp-N-TSR10-_-Failed\\\",\\\"PXPSD2Comp-R-_-_-Failed\\\",\\\"PXPSD2SettingVersionV19\\\"],\\\"PayerAuthApiVersion\\\":\\\"2019-04-16\\\",\\\"AccountId\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"BrowserInfo\\\":{\\\"browser_accept_header\\\":\\\"*/*\\\",\\\"browser_ip\\\":\\\"::1\\\",\\\"browser_java_enabled\\\":true,\\\"browser_language\\\":\\\"en-US\\\",\\\"browser_color_depth\\\":\\\"8\\\",\\\"browser_screen_height\\\":\\\"480\\\",\\\"browser_screen_width\\\":\\\"640\\\",\\\"browser_tz\\\":\\\"480\\\",\\\"browser_user_agent\\\":\\\"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36\\\",\\\"challenge_window_size\\\":\\\"05\\\"},\\\"MethodData\\\":{\\\"three_ds_server_trans_id\\\":\\\"123\\\",\\\"three_ds_method_url\\\":\\\"https://testurl.com\\\"},\\\"AuthenticationResponse\\\":{\\\"enrollment_status\\\":\\\"bypassed\\\",\\\"enrollment_type\\\":\\\"three_ds\\\",\\\"three_ds_server_transaction_id\\\":\\\"73f512ef-48fb-4322-b87d-ce6a3622ef1b\\\",\\\"acs_url\\\":\\\"https://payments-acs-emulator-fzeug0g7atchf8d7.b02.azurefd.net/payments/ve1_2/challenge\\\",\\\"acs_transaction_id\\\":null,\\\"authenticate_update_url\\\":\\\"/bd888d21-f2a9-4f8b-92c2-129b8d4748b6/payments/Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec/authenticate\\\",\\\"acs_signed_content\\\":\\\"{\\\\\\\"MD\\\\\\\":\\\\\\\"A4560000307199\\\\\\\",\\\\\\\"PaReq\\\\\\\":\\\\\\\"eyJhdXRoZW50aWNhdGlvbmlkIjoiNzNmNTEyZWYtNDhmYi00MzIyLWI4N2QtY2U2YTM2MjJlZjFiIn0=\\\\\\\",\\\\\\\"TermUrl\\\\\\\":\\\\\\\"https://www.merchanturl.com/Response.jsp\\\\\\\"}\\\",\\\"transaction_challenge_status\\\":\\\"C\\\",\\\"transaction_challenge_status_reason\\\":\\\"01\\\",\\\"card_holder_info\\\":null,\\\"acs_rendering_type\\\":null,\\\"acs_challenge_mandated\\\":null,\\\"acs_operator_id\\\":null,\\\"acs_reference_number\\\":null,\\\"authentication_type\\\":null,\\\"ds_reference_number\\\":null,\\\"is_form_post_acs_url\\\":true,\\\"is_full_page_redirect\\\":true},\\\"billableAccountId\\\":null,\\\"classicProduct\\\":null,\\\"EmailAddress\\\":null,\\\"Language\\\":\\\"en-US\\\",\\\"SuccessUrl\\\":null,\\\"FailureUrl\\\":null,\\\"ChallengeStatus\\\":\\\"Unknown\\\",\\\"payment_session_id\\\":\\\"Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec\\\",\\\"account_id\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"caid\\\":null,\\\"payment_instrument_id\\\":\\\"9MEvEAAAAAAEAACA\\\",\\\"partner\\\":\\\"" + partner + "\\\",\\\"amount\\\":" + amount + ",\\\"currency\\\":\\\"INR\\\",\\\"country\\\":\\\"IN\\\",\\\"has_pre_order\\\":" + isPreOrder.ToString().ToLower() + ",\\\"is_legacy\\\":false,\\\"is_moto\\\":false,\\\"three_dsecure_scenario\\\":\\\"PaymentTransaction\\\",\\\"payment_method_family\\\":\\\"credit_card\\\",\\\"payment_method_type\\\":\\\"visa\\\",\\\"device_channel\\\":\\\"browser\\\",\\\"is_challenge_required\\\":true,\\\"purchaseOrderId\\\":null,\\\"cvv_token \\\":null}\",\"encrypt_data\":false,\"state\":\"INCOMPLETE\",\"test_context\":{\"scenarios\":\"px-service-billdesk-provider,px-service-psd2-e2e-emulator,px-service-3ds1-show-iframe\",\"contact\":\"kowshikp\",\"context_props\":{}}}";
            PXSettings.SessionService.ResponseProvider.SessionStore.Add(paymentSessionId, sessionResp);
            ...
            PXSettings.PaymentOrchestratorService.PreProcess = (poRequestData) =>
            {
                poAttachChallengeDataAPIisCalled = poRequestData.RequestUri.AbsolutePath.Contains("attachChallengeData") || poAttachChallengeDataAPIisCalled;
            };

            PXSettings.PimsService.PreProcess = (pimsRequestData) =>
            {
                pimsValidateChallengeDataAPIisCalled = pimsRequestData.RequestUri.AbsolutePath.Contains("validate") || pimsValidateChallengeDataAPIisCalled;
                pimsLinkTransactionAPIisCalled = pimsRequestData.RequestUri.AbsolutePath.Contains("LinkTransaction") || pimsLinkTransactionAPIisCalled;
            };
            ...
            Assert.IsNotNull(responseBody);
            Assert.AreEqual(poAttachChallengeDataAPIisCalled, isPaaSflow, "poAttachChallengeData should be called for paas flow");
            Assert.AreEqual(pimsValidateChallengeDataAPIisCalled, shouldDoValidatePI, "pimsValidate should not be called");
            Assert.AreNotEqual(pimsLinkTransactionAPIisCalled, isPaaSflow, "pimsLinkTransactionAPI should not be call for paas flow");
        ...
        [DataRow("https%3A%2F%2Fsubs-paynow.msdx.microsoft.com")]
        [DataRow("https%3A%2F%2Fsubs-paynow.msdx.microsoft-ppe.com")]
        [DataRow("https%3A%2F%2Fcheckout.microsoft365.com")]
        [DataRow("https%3A%2F%2Fcheckout.office.com")]
        ...
        [DataRow("cart", null, false)]
        [TestMethod]
        public async Task PaymentSessions_BrowserNotifyThreeDSOneChallengeCompleted_checkoutRequestFlow(string partner, string requestId, bool requestContextHeaderIsFromPIFD)
        {
            string paymentSessionId = "ZFFFFFFFFFFF78a93cbb-8a57-49d9-84b7-42c5f042dba6";
            string sessionResp = "{\"id\":\"" + paymentSessionId + "\",\"session_type\":\"any\",\"Data\":\"{\\\"requestId\\\":\\\"" + requestId + "\\\",\\\"tenantId\\\":\\\"tenantIdFromSession\\\",\\\"ExposedFlightFeatures\\\":[\\\"PXPSD2Auth-_-_-Succeeded\\\",\\\"PXPSD2Auth-C-_-Unknown\\\",\\\"PXPSD2Auth-N-TSR10-Failed\\\",\\\"PXPSD2Auth-R-_-Failed\\\",\\\"PXPSD2Comp-_-_-_-Succeeded\\\",\\\"PXPSD2Comp-_-_-01-Cancelled\\\",\\\"PXPSD2Comp-N-_-04-TimedOut\\\",\\\"PXPSD2Comp-N-TSR10-_-Failed\\\",\\\"PXPSD2Comp-R-_-_-Failed\\\",\\\"PXPSD2SettingVersionV19\\\"],\\\"PayerAuthApiVersion\\\":\\\"2019-04-16\\\",\\\"AccountId\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"BrowserInfo\\\":{\\\"browser_accept_header\\\":\\\"*/*\\\",\\\"browser_ip\\\":\\\"::1\\\",\\\"browser_java_enabled\\\":true,\\\"browser_language\\\":\\\"en-US\\\",\\\"browser_color_depth\\\":\\\"8\\\",\\\"browser_screen_height\\\":\\\"480\\\",\\\"browser_screen_width\\\":\\\"640\\\",\\\"browser_tz\\\":\\\"480\\\",\\\"browser_user_agent\\\":\\\"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36\\\",\\\"challenge_window_size\\\":\\\"05\\\"},\\\"MethodData\\\":{\\\"three_ds_server_trans_id\\\":\\\"123\\\",\\\"three_ds_method_url\\\":\\\"https://testurl.com\\\"},\\\"AuthenticationResponse\\\":{\\\"enrollment_status\\\":\\\"bypassed\\\",\\\"enrollment_type\\\":\\\"three_ds\\\",\\\"three_ds_server_transaction_id\\\":\\\"73f512ef-48fb-4322-b87d-ce6a3622ef1b\\\",\\\"acs_url\\\":\\\"https://payments-acs-emulator-fzeug0g7atchf8d7.b02.azurefd.net/payments/ve1_2/challenge\\\",\\\"acs_transaction_id\\\":null,\\\"authenticate_update_url\\\":\\\"/bd888d21-f2a9-4f8b-92c2-129b8d4748b6/payments/Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec/authenticate\\\",\\\"acs_signed_content\\\":\\\"{\\\\\\\"MD\\\\\\\":\\\\\\\"A4560000307199\\\\\\\",\\\\\\\"PaReq\\\\\\\":\\\\\\\"eyJhdXRoZW50aWNhdGlvbmlkIjoiNzNmNTEyZWYtNDhmYi00MzIyLWI4N2QtY2U2YTM2MjJlZjFiIn0=\\\\\\\",\\\\\\\"TermUrl\\\\\\\":\\\\\\\"https://www.merchanturl.com/Response.jsp\\\\\\\"}\\\",\\\"transaction_challenge_status\\\":\\\"C\\\",\\\"transaction_challenge_status_reason\\\":\\\"01\\\",\\\"card_holder_info\\\":null,\\\"acs_rendering_type\\\":null,\\\"acs_challenge_mandated\\\":null,\\\"acs_operator_id\\\":null,\\\"acs_reference_number\\\":null,\\\"authentication_type\\\":null,\\\"ds_reference_number\\\":null,\\\"is_form_post_acs_url\\\":true,\\\"is_full_page_redirect\\\":true},\\\"billableAccountId\\\":null,\\\"classicProduct\\\":null,\\\"EmailAddress\\\":null,\\\"Language\\\":\\\"en-US\\\",\\\"SuccessUrl\\\":null,\\\"FailureUrl\\\":null,\\\"ChallengeStatus\\\":\\\"Unknown\\\",\\\"payment_session_id\\\":\\\"Z10007BHY0DT9b144cbe-f57f-4af2-85e3-dfd2c023d4ec\\\",\\\"account_id\\\":\\\"bd888d21-f2a9-4f8b-92c2-129b8d4748b6\\\",\\\"caid\\\":null,\\\"payment_instrument_id\\\":\\\"9MEvEAAAAAAEAACA\\\",\\\"partner\\\":\\\"" + partner + "\\\",\\\"amount\\\":100.0,\\\"currency\\\":\\\"INR\\\",\\\"country\\\":\\\"IN\\\",\\\"has_pre_order\\\":false,\\\"is_legacy\\\":false,\\\"is_moto\\\":false,\\\"three_dsecure_scenario\\\":\\\"PaymentTransaction\\\",\\\"payment_method_family\\\":\\\"credit_card\\\",\\\"payment_method_type\\\":\\\"visa\\\",\\\"device_channel\\\":\\\"browser\\\",\\\"is_challenge_required\\\":true,\\\"purchaseOrderId\\\":null,\\\"cvv_token \\\":null}\",\"encrypt_data\":false,\"state\":\"INCOMPLETE\",\"test_context\":{\"scenarios\":\"px-service-billdesk-provider,px-service-psd2-e2e-emulator,px-service-3ds1-show-iframe\",\"contact\":\"kowshikp\",\"context_props\":{}}}";
            PXSettings.SessionService.ResponseProvider.SessionStore.Add(paymentSessionId, sessionResp);

            HttpRequestMessage requestMessage = new HttpRequestMessage(HttpMethod.Post, GetPXServiceUrl(string.Format("/v7.0/paymentSessions/{0}/NotifyThreeDSChallengeCompleted", paymentSessionId)))
            {
                Content = new StringContent("PaRes=eyJhdXRoZW50aWNhdGlvbmlkIjoiMmQ4YWY4NzktYjdlMi00NDVmLWFjNWUtNGEwMGQ0MDJhZjRlIiwiYXV0aGVudGljYXRpb25fc3RhdHVzIjoic3VjY2VzcyJ9", Encoding.UTF8, PaymentConstants.HttpMimeTypes.FormContentType)
            };

            requestMessage.Headers.Add("x-ms-test", "{\"scenarios\":\"px.po.confirm\",\"contact\":\"pidlsdk\"}");

            if (requestContextHeaderIsFromPIFD)
            {
                requestMessage.Headers.Add("x-ms-request-context", "{\"tenantId\":\"tenantIdFromPIFD\"}");
            }
        ...
        [DataRow(0, true, "officesmb", false, false)] // For OfficeSMB without the feature, there is no challenge.
        [DataRow(0, true, "officesmb", true, true)] // For OfficeSMB with the feature, there is a challenge.
        public async Task CreatePaymentSession_ChallengeDescriptions_ValidatePIOnAttach_GooglePay(int amount, bool hasPreOrder, string partner, bool validatePIOnAttachExpected, bool pimsReturnsValidatePIFailed, bool isFeatureEnableValidatePIOnAttachChallenge = false)
        {
            // Arrange
            PXSettings.PayerAuthService.ResponseProvider.SessionId = Guid.NewGuid().ToString();
            PXSettings.PimsService.PostProcess = async (pimsValidateResponse) =>
            ...
            PXFlightHandler.AddToEnabledFlights("PXUsePaymentSessionsHandlerV2,PXEnablePSD2ForGooglePay");
                    ...
                    string.Format(
                        ...
                        HttpUtility.UrlEncode(JsonConvert.SerializeObject(
                            new PaymentSessionData()
                            {
                                ...
                                Country = "gb",
                                HasPreOrder = hasPreOrder,
                                PaymentInstrumentId = "cw_gpay_cc80ac8e-3e33-40f3-9fed-6efb5be47762",
                                Language = "en"
                            })))));
        ...
        [DataRow(Partners.OfficeSMB, "PXEnableHandleTransactionNotAllowed")]
        [DataRow(Partners.OfficeSMB, null)]
        [DataRow(Partners.Azure, "PXEnableHandleTransactionNotAllowed")]
        [DataRow(Partners.Azure, null)]
        [TestMethod]
        public async Task PaymentSessions_AuthenticateIndiaThreeDS_UserErrorFailure(string partner, string flight = null)
        {
            // Arrange
            string accountId = "Account001";
            string paymentSessionId = "ZFFFFFFFFFFF78a93cbb-8a57-49d9-84b7-42c5f042dba6";
            string action = "AuthenticateIndiaThreeDS";
            ...
            request.Headers.Add("x-ms-test", "{\"scenarios\":\"px-service-Auth3ds-test-emulator-user-error\",}");
            ...
            {
                Assert.AreEqual(HttpStatusCode.InternalServerError, pxResponse.StatusCode);
            }
            ...
            Assert.AreEqual(ClientActionType.Failure, responseBody.ClientAction.ActionType);

            Assert.AreEqual(serviceError.ErrorCode, "Card Account not found");
        }
        ...
        [DataRow(PaymentChallengeStatus.NotApplicable)]
        [TestMethod]
        public async Task PaymentSessions_AuthenticationStatus_ReturnsVerifiedTrue_IsChallengeRequiredFalse_PaymentInstrumentSession_Exception(PaymentChallengeStatus challengeStatus)
        {
            // Arrange
        ...
        [DataRow(VerificationResult.Success, true, true, "USD", "100.0", "100.0", "110.0")]
        [DataRow(VerificationResult.Success, true, false, "USD", "100.0", "100.0", "110.0")]
        [DataRow(VerificationResult.CurrencyMismatch, false, true, "INR", "100.0", "100.0", "110.0")]
        [DataRow(VerificationResult.AmountMismatch, false, true, "USD", "100.0", "800.0", "810.0")]
        [DataRow(VerificationResult.CurrencyMismatch, false, false, "INR", "100.0", "100.0", "110.0")]
        [DataRow(VerificationResult.CurrencyMismatch, true, true, "INR", "0", "0.0", "0.0")]
        [DataRow(VerificationResult.AmountMismatch, true, true, "USD", "0", "0.0", "0.0")]
        [DataRow(VerificationResult.Success, true, true, null, "100.0", null, null)]
        [TestMethod]
        public async Task PaymentSessions_AuthenticationStatus_VerificationCheck_PaymentContext(VerificationResult verificationStatusType, bool verified, bool flightRequired, string currency, string testAmount, string preTax, string postTax)
        {
            if (flightRequired)
            {
            ...
            var piId = "Pi001-Visa-3DS2";
            var sessionId = "ZFFFFFFFFFFF12345678-1234-1234-1234-123456789012";
            var response = "{\"Id\":\"" + sessionId + "\",\"piCid\":\"" + accountId + "\",\"SessionType\":0,\"Data\":\"{\\\"ExposedFlightFeatures\\\":[],\\\"PayerAuthApiVersion\\\":\\\"2019-04-16\\\",\\\"AccountId\\\":\\\"" + accountId + "\\\",\\\"BrowserInfo\\\":null,\\\"MethodData\\\":null,\\\"AuthenticationResponse\\\":null,\\\"billableAccountId\\\":null,\\\"classicProduct\\\":null,\\\"EmailAddress\\\":null,\\\"Language\\\":\\\"en-us\\\",\\\"payment_session_id\\\":\\\"" + sessionId + "\\\",\\\"account_id\\\":\\\"" + accountId + "\\\",\\\"caid\\\":null,\\\"payment_instrument_id\\\":\\\"" + piId + "\\\",\\\"partner\\\":\\\"Azure\\\",\\\"ChallengeStatus\\\":\\\"" + PaymentChallengeStatus.Succeeded + "\\\",\\\"amount\\\":\\\"" + testAmount + "\\\",\\\"currency\\\":\\\"USD\\\",\\\"country\\\":\\\"us\\\",\\\"has_pre_order\\\":true,\\\"is_legacy\\\":false,\\\"is_moto\\\":false,\\\"three_dsecure_scenario\\\":\\\"PaymentTransaction\\\",\\\"payment_method_family\\\":\\\"credit_card\\\",\\\"payment_method_type\\\":\\\"MasterCard\\\",\\\"device_channel\\\":\\\"browser\\\",\\\"is_challenge_required\\\":true,\\\"purchaseOrderId\\\":null}\",\"EncryptData\":false,\"Result\":null,\"State\":\"INCOMPLETE\",\"TestContext\":null}";
            var paymentContext = "%7b%22currency%22%3a%22" + currency + "%22%2c%22country%22%3a%22in%22%2c%22hasPreOrder%22%3afalse%2c%22isMOTO%22%3afalse%2c%22challengeScenario%22%3a%22PaymentTransaction%22%2c%22purchaseOrderId%22%3a%22123456%22%2c%22preTax%22%3a" + preTax + "%2c%22postTax%22%3a" + postTax + "%7d";

            if (verificationStatusType == VerificationResult.CurrencyMismatch)
            {
                paymentContext = "%7b%22currency%22%3a%22INR%22%2c%22country%22%3a%22in%22%2c%22hasPreOrder%22%3afalse%2c%22isMOTO%22%3afalse%2c%22challengeScenario%22%3a%22PaymentTransaction%22%2c%22purchaseOrderId%22%3a%22123456%22%2c%22preTax%22%3a" + preTax + "%2c%22postTax%22%3a" + postTax + "%7d";
            }
            ...
            // Act
            var pxResponse = await PXClient.GetAsync(
                GetPXServiceUrl(string.Format("/v7.0/{0}/paymentSessions/{1}/{2}/AuthenticationStatus?paymentContext={3}", accountId, sessionId, piId, paymentContext)));
            var pxContent = JsonConvert.DeserializeObject<AuthenticationStatus>(await pxResponse.Content.ReadAsStringAsync());

            // Assert
            if (currency != null && preTax != null && postTax != null) 
            {
                Assert.AreEqual(HttpStatusCode.OK, pxResponse.StatusCode, "StatusCode");
                Assert.AreEqual(piId, pxContent.PiId, "PiId");
                Assert.AreEqual(sessionId, pxContent.SessionId, "SessionId");
                ...
                if (flightRequired)
                {
                    Assert.AreEqual(verified, pxContent.Verified);

                    if (pxContent.FailureReason.HasValue)
                    {
                        Assert.AreEqual(verificationStatusType.ToString(), pxContent.FailureReason.ToString());
                    }
                }
                else
                {
                    Assert.AreEqual(true, pxContent.Verified);
                }
            }
            else
            {
        ...
        [TestMethod]
        public async Task PaymentSessions_AuthenticationStatus_ThrowsNotFound_WhenPIDoNotExist()
        {
            // Arrange
            var accountId = "Account001";
            var piId = "Pi001-Visa-3DS2";
