...
internal sealed class Program
{
    public static async Task Main(string[] args)
    {
        ...
        {
            fullBaseUrl = $"{protocol}://localhost";
        }
        ...
        var country = "us";
        var addressType = "hapi1";
        // Warm up like before (no real network I/O; this goes through TestServer).
        requestUrl = $"/v7.0/Account001/AddressDescriptions?country={country}&type={addressType}&language=en-US&partner=officesmb&operation=add";
