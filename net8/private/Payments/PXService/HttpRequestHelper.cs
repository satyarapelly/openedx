...
namespace Microsoft.Commerce.Payments.PXService
{
    ...
    public static class HttpRequestHelper
    {
        ...
        public static string GetRequestHeader(string headerName)
        {
            ...
            {
                headerValue = context.Request.Headers[headerName];
            }
        ...
        public static TestContext GetTestHeader(HttpRequest request)
        {
            TestContext testContext = null;

            if (request.Headers.TryGetValue(PaymentConstants.PaymentExtendedHttpHeaders.TestHeader, out StringValues headerValues))
            {
                ...
                if (!string.IsNullOrEmpty(headerValue))
                {
                    try
                    {
                        testContext = JsonConvert.DeserializeObject<TestContext>(headerValue);
                    }
                    catch
                    {
