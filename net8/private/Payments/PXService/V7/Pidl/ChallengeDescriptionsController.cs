...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class ChallengeDescriptionsController : ProxyController
    {
        ...
        public async Task<ActionResult<List<PIDLResource>>> GetByPiidAndSessionId(
                [FromRoute] string accountId, [FromRoute] string piid, [FromRoute] string sessionId,
                [FromQuery] string partner = null, [FromQuery] string language = null, [FromQuery] string orderId = null)
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
