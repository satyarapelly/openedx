...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class TenantDescriptionsController : ControllerBase
    {
        ...
        [HttpGet]
        public List<PIDLResource> Get([FromRoute] string accountId, [FromQuery] string type, [FromQuery] string country, [FromQuery] string language = null, [FromQuery] string partner = Constants.ServiceDefaults.DefaultPartnerName)
        {
