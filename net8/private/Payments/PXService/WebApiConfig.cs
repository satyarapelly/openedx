    ...
    public static class WebApiConfig
    {
        ...
        public static void AddUrlVersionedRoutes(IEndpointRouteBuilder endpoints)
        {
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.AddressesExController), action = "Post" });
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.ChallengeDescriptionsController), action = "GetByTypePiidAndSessionId" });
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.AddressesController) });
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.RDSSessionController), action = "Query" });
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.AddressDescriptionsController), action = "GetAddressDescriptions" });
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.CheckoutDescriptionsController), action = "GetCheckoutDescriptions" });
            ...
            endpoints.MapControllerRoute(
                ...
                defaults: new { controller = C(GlobalConstants.ControllerNames.CheckoutsExController) });
