...
namespace Microsoft.Commerce.Payments.Common.Web
{
    ...
    public class VersionedControllerSelector
    {
        ...
        /// </summary>
        public IReadOnlyDictionary<string, ApiVersion> SupportedVersions => this.supportedVersions;
        ...
        public void AddVersion(string version, Dictionary<string, Type> controllers)
        {
            ...
            this.supportedVersions[version] = new ApiVersion(version, internalVersion);
            this.versionedControllers[version] = controllers;
        }
        ...
        public void AddVersionless(string controllerName, Type controllerType)
        {
            ...
            this.versionlessControllers[controllerName] = controllerType;
        }
        ...
        public Type? ResolveAllowedController(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(version) && versionedControllers.TryGetValue(version, out versionMap))
            {
                if (versionMap.TryGetValue(controllerName, out controllerType))
                    return controllerType;
            }
