...
namespace QRCoder
{
    public static class PayloadGenerator
    {
            ...
            public override string ToString()
            {
                switch (this.encoding)
                {
                    ...
                    case GeolocationEncoding.GoogleMaps:
                        return $"http://maps.google.com/maps?q={this.latitude},{this.longitude}"; // lgtm[cs/non-https-url] Suppressing Semmle warning // DevSkim: ignore DS137138 as not making changes to this OSS code
                    default:
                        return "geo:";
                }
            }
        ...
        public class Url : Payload
        {
            ...
            public override string ToString()
            {
                return (!this.url.StartsWith("http") ? "http://" + this.url : this.url); // lgtm[cs/non-https-url] Suppressing Semmle warning   // DevSkim: ignore DS137138 as not making changes to this OSS code
            }
        }
...
#pragma warning disable 0612
            ...
            public enum Currency
            {
                ...
                XPT = 962,
                XSU = 994,
                XTS = 963, // DevSkim: ignore DS187371 as this triggered as a false positive.  This is not a Hash Algorithm.
                XUA = 965,
                XXX = 999,
                YER = 886,
                ZAR = 710,
...
#pragma warning restore 0612
        ...
        public class OneTimePassword : Payload
        {
            ...
            public OneTimePasswordAuthAlgorithm AuthAlgorithm { get; set; } = OneTimePasswordAuthAlgorithm.SHA1; // DevSkim: ignore DS126858 as this code is not used
            ...
            {
                SHA1, // DevSkim: ignore DS126858 as this code is not used
                SHA256,
                SHA512,
            }
