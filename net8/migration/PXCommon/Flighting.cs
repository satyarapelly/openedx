...
namespace Microsoft.Commerce.Payments.PXCommon
{
    ...
    public static class Flighting
    {
        ...
        public static class Features
        {
            ...
            // shows rewards error page when a challenge is mandated by ms rewards service
            public const string PXShowRewardsErrorPageOnChallenge = "PXShowRewardsErrorPageOnChallenge";
