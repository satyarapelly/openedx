// <copyright file="ChallengeIFrameDisplayHint.cs" company="Microsoft">Copyright (c) Microsoft 2018. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PidlModel.V7
{
    ...
    public sealed class ChallengeIFrameDisplayHint : ContentDisplayHint
    {
        private string sourceUrl;

        public ChallengeIFrameDisplayHint()
        {
        }

        public ChallengeIFrameDisplayHint(IFrameDisplayHint template, Dictionary<string, string> contextTable)
        ...
        {
            return HintType.ChallengeIFrame.ToString().ToLower();
        }
    }
}
