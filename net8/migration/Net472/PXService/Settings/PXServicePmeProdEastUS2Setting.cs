// <copyright file="PXServicePmeProdEastUS2Setting.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmeProdEastUS2Setting : PXServiceProdSettings
    {
        ...
        public PXServicePmeProdEastUS2Setting() : base()
        {
            this.PIMSAccessor = new PIMSAccessor(
                serviceBaseUrl: this.PimsBaseUrl,
                emulatorBaseUrl: "https://px-pxdependencyemulators-prod-eastus2.azurewebsites.net",
