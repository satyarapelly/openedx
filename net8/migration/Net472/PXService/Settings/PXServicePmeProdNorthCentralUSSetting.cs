// <copyright file="PXServicePmeProdNorthCentralUSSetting.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmeProdNorthCentralUSSetting : PXServiceProdSettings
    {
        ...
        public PXServicePmeProdNorthCentralUSSetting() : base()
        {
            this.PIMSAccessor = new PIMSAccessor(
                serviceBaseUrl: this.PimsBaseUrl,
                emulatorBaseUrl: "https://px-pxdependencyemulators-prod-northcentralus.azurewebsites.net",
