// <copyright file="PXServicePmePpeEastUSSettings.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmePpeEastUSSettings : PXServiceProdSettings
    {
        ...
        public PXServicePmePpeEastUSSettings() : base()
        {
            ...
            this.PIMSAccessor = new PIMSAccessor(
                ...
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-eastus.azurewebsites.net",
            ...
            this.CatalogServiceAccessor = new CatalogServiceAccessor(
                serviceBaseUrl: "https://px-pxdependencyemulators-ppe-eastus.azurewebsites.net",
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-eastus.azurewebsites.net",
            ...
            this.StoredValueServiceAccessor = new StoredValueAccessor(
                ...
                emulatorBaseUrl: "https://px-storedvalueemulator-ppe-eastus.azurewebsites.net",
