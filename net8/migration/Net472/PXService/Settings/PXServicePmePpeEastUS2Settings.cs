// <copyright file="PXServicePmePpeEastUS2Settings.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmePpeEastUS2Settings : PXServiceProdSettings
    {
        ...
        public PXServicePmePpeEastUS2Settings() : base()
        {
            ...
            this.PIMSAccessor = new PIMSAccessor(
                ...
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-eastus2.azurewebsites.net",
            ...
            this.CatalogServiceAccessor = new CatalogServiceAccessor(
                serviceBaseUrl: "https://px-pxdependencyemulators-ppe-eastus2.azurewebsites.net",
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-eastus2.azurewebsites.net",
