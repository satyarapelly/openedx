// <copyright file="PXServicePmeProdCentralUSSetting.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmeProdCentralUSSetting : PXServiceProdSettings
    {
        ...
        public PXServicePmeProdCentralUSSetting() : base()
        {
            this.PIMSAccessor = new PIMSAccessor(
                serviceBaseUrl: this.PimsBaseUrl,
                emulatorBaseUrl: "https://px-pxdependencyemulators-prod-centralus.azurewebsites.net",
