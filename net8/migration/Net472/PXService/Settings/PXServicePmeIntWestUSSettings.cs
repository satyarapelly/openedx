// <copyright file="PXServicePmeIntWestUSSettings.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmeIntWestUSSettings : PXServiceIntSettings
    {
        ...
        public PXServicePmeIntWestUSSettings() : base()
        {
            ...
            this.PIMSAccessor = new PIMSAccessor(
                ...
                emulatorBaseUrl: "https://app-px-dependencyemulators-px-int-wus-1.azurewebsites.net",
            ...
            this.PurchaseServiceAccessor = new PurchaseServiceAccessor(
                serviceBaseUrl: "https://app-px-dependencyemulators-px-int-wus-1.azurewebsites.net",
                emulatorBaseUrl: "https://app-px-dependencyemulators-px-int-wus-1.azurewebsites.net",
