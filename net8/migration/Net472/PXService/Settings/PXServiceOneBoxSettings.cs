...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServiceOneBoxSettings : PXServiceSettings
    {
        ...
        public PXServiceOneBoxSettings()
        {
            ...
            var orchestrationServiceWebRequestHandler = new WebRequestHandler();
            ...
            var pimsWebRequestHandler = new WebRequestHandler();
            ...
            var accountServiceRequestHandler = new WebRequestHandler();
            ...
            var riskWebRequestHandler = new WebRequestHandler();
            ...
            var taxIdWebRequestHandler = new WebRequestHandler();
            ...
            var sessionServiceRequestHandler = new WebRequestHandler();
            ...
            var payAuthWebRequestHandler = new WebRequestHandler();
            ...
            var purchaseWebRequestHandler = new WebRequestHandler();
            ...
            var catalogWebRequestHandler = new WebRequestHandler();
            ...
            var tokenPolicyRequestHandler = new WebRequestHandler();
            ...
            var storedValueWebRequestHandler = new WebRequestHandler();
            ...
            var addressEnrichmentWebRequestHandler = new WebRequestHandler();
            ...
            var transactionServiceWebRequestHandler = new WebRequestHandler();
            ...
            var sellerMarketPlaceServiceWebRequestHandler = new WebRequestHandler();
            ...
            var thirdPartyMarketPlaceServiceWebRequestHandler = new WebRequestHandler();
            ...
            var issuerServiceRequestHandler = new WebRequestHandler();
            ...
            var shortUrlRequestHandler = new WebRequestHandler();
            ...
            var partnerSettingsRequestHandler = new WebRequestHandler();
            ...
            var walletWebRequestHandler = new WebRequestHandler();
            ...
            var transactionDataWebRequestHandler = new WebRequestHandler();
            ...
            var challengeManagementServiceRequestHandler = new WebRequestHandler();
            ...
            var networkTokenizationServiceRequestHandler = new WebRequestHandler();
            ...
            var tokenizationServiceRequestHandler = new WebRequestHandler();
            ...
            var paymentOrchestratorServiceWebRequestHandler = new WebRequestHandler();
            ...
            var fraudDetectionMessageHandler = new WebRequestHandler();
