...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class SessionsController : ProxyController
    {
        ...
        public async Task<SecondScreenSessionData> GetBySessionId([FromUri]string sessionId)
        {
            ...
            PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.GetSession, this.Request.RequestUri.AbsolutePath, traceActivityId);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.PostSessionId, this.Request.RequestUri.AbsolutePath, traceActivityId);
            return sessionId;
        }
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.PostSession, this.Request.RequestUri.AbsolutePath, traceActivityId);
