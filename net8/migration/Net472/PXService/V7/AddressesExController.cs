...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class AddressesExController : ProxyController
    {
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.PostAddress, this.Request.RequestUri.AbsolutePath, traceActivityId);
