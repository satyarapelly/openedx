...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class AddressDescriptionsController : ProxyController
    {
            ...
            bool setAsDefaultBilling = false)
        {
            ...
            PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.GetAddressDescriptions, this.Request.RequestUri.AbsolutePath, traceActivityId);
