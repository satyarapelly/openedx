...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class ChallengeDescriptionsController : ProxyController
    {
            ...
            string partner = Constants.ServiceDefaults.DefaultPartnerName)
        {
            ...
            PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.GetChallengeDescriptions, this.Request.RequestUri.AbsolutePath, traceActivityId);
