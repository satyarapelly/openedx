...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class DescriptionsController : ProxyController
    {
        ...
        /// <param name="windowSize">challenge window size value</param>
            ...
            string windowSize = null)
        {
            ...
            await componentInstance.LoadComponentDescription(requestContext?.RequestId, this.Settings, traceActivityId, setting, this.ExposedFlightFeatures, operation: operation, partner: partner, family: family, type: type, scenario: scenario, request: this.Request, piid: piid, challengeWindowSize: windowSize);
