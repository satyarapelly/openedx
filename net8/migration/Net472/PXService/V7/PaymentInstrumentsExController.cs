...
namespace Microsoft.Commerce.Payments.PXService.V7
{
    ...
    public class PaymentInstrumentsExController : ProxyController
    {
            ...
            [FromUri] string orderId = null)
        {
            ...
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.PostPaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.ListPaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            ...
            [FromUri] string sessionId = null)
        {
            ...
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.GetPaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.UpdatePaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddPartnerProperty(partner?.ToLower());
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.ReplacePaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddPartnerProperty(partner?.ToLower());
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.RedeemPaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
            this.Request.AddPartnerProperty(partner?.ToLower());
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.RemovePaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.ResumePendingOperationEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
            this.Request.AddPartnerProperty(partner?.ToLower());
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.GetCardProfileEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.GetSeCardPersosEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.PostReplenishTransactionCredentialsEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.AcquireLUKs, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.ConfirmLUKs, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.ValidateCvv, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddTracingProperties(accountId, piid, null, null);
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.ApplyPaymentInstrumentEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            this.Request.AddPartnerProperty(partner?.ToLower());
        ...
        {
            EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
            PaymentsEventSource.Log.PXServiceTraceRequest(GlobalConstants.APINames.GetChallengeContextEx, this.Request.RequestUri.AbsolutePath, traceActivityId);
            ...
            string requestId = null)
        {
                ...
                if (!string.IsNullOrWhiteSpace(requestId))
                {
                    if (this.ExposedFlightFeatures.Contains(Flighting.Features.PXIntegrateFraudDetectionService, StringComparer.OrdinalIgnoreCase))
                    {
                        ...
                        catch (Exception botCheckResultException)
                        {
                            ...
                            PaymentsEventSource.Log.TracingHandlerTraceError($"PX Fraud Detection Service Failure. Error: {botCheckResultException.Message} for AccountId {accountId}, family {paymentMethodFamily}, type {paymentMethodType}.", traceActivityId);
                        }
                    }
            ...
            if (ex != null)
            {
                        ...
                        && !string.Equals(partner, Constants.PartnerName.Wallet, StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    if (this.ExposedFlightFeatures.Contains(Flighting.Features.PXChallengeSwitch) && string.Equals(ex.Error.ErrorCode, Constants.CreditCardErrorCodes.ChallengeRequired, StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        catch (Exception pxChallengeClientActionCreationException)
                        {
                            PaymentsEventSource.Log.TracingHandlerTraceError($"PX Challenge Client Action Creation Failure. Error: {pxChallengeClientActionCreationException.Message} for PXChallengeSessionID {pxChallengeSessionId}, AccountId {accountId}, family {paymentMethodFamily}, type {paymentMethodType}.", traceActivityId);
                        }
                    }
            ...
            if (this.ExposedFlightFeatures.Contains(Flighting.Features.PXChallengeSwitch, StringComparer.OrdinalIgnoreCase) && !string.IsNullOrEmpty(pxChallengeSessionId))
            {
                ...
                catch (Exception pxSessionUpdateException)
                {
                    PaymentsEventSource.Log.TracingHandlerTraceError($"Update PXSession Status Failure. Error: {pxSessionUpdateException.Message} for PXChallengeSessionID {pxChallengeSessionId}, AccountId {accountId}, family {paymentMethodFamily}, type {paymentMethodType}.", traceActivityId);
                }
            }
        ...
        private async Task TryUpdateAddressWith9digitZipCode(PIDLData pi)
        {
            ...
            {
                EventTraceActivity traceActivityId = this.Request.GetRequestCorrelationId();
                PaymentsEventSource.Log.InstrumentManagementServiceTraceRequest(GlobalConstants.APINames.TryUpdateAddressWith9digitZipCode, this.Request.RequestUri.AbsolutePath, traceActivityId);
            ...
            switch (actionType)
            {
                ...
                case "redeem":
                    ...
                    if (redeemResult?.IsSuccess ?? false)
                    {
                        ...
                        {
                            PaymentsEventSource.Log.TracingHandlerTraceError($"Failed to get CSV PI details. Error: {ex.Message}", traceActivityId);
                        }
