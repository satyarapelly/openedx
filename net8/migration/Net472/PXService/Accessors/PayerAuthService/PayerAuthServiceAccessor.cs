...
namespace Microsoft.Commerce.Payments.PXService
{
    ...
    public class PayerAuthServiceAccessor : IPayerAuthServiceAccessor
    {
            ...
            HttpMessageHandler messageHandler)
        {
            ...
            this.payerAuthServiceHttpClient = new PXTracingHttpClient(Constants.ServiceNames.PayerAuthService, messageHandler, ApplicationInsightsProvider.LogOutgoingOperation);
            ...
            string apiVersion = null)
        {
            ...
            PaymentsEventSource.Log.PXServiceRequestToPayerAuthService(fullRequestUrl, traceActivityId);
            using (HttpRequestMessage requestMessage = new HttpRequestMessage(method, fullRequestUrl))
            {
                ...
                using (HttpResponseMessage response = await this.payerAuthServiceHttpClient.SendAsync(requestMessage))
                {
                    ...
                    PaymentsEventSource.Log.PXServiceTraceResponseFromPayerAuthService(response.StatusCode.ToString(), responseMessage, traceActivityId);
