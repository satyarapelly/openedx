// <copyright file="ValidateChallengeRequest.cs" company="Microsoft">Copyright (c) Microsoft. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Model.NetworkTokenizationService
{
    ...
    public class ValidateChallengeRequest
    {
        ...
        /// <summary>
        /// Gets or sets the OTP (one time password) received by the customer.
        /// Mandatory.
        /// </summary>
