// <copyright file="PXServicePmeProdEastUSSetting.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmeProdEastUSSetting : PXServiceProdSettings
    {
        ...
        public PXServicePmeProdEastUSSetting() : base()
        {
            this.PIMSAccessor = new PIMSAccessor(
                serviceBaseUrl: this.PimsBaseUrl,
                emulatorBaseUrl: "https://px-pxdependencyemulators-prod-eastus.azurewebsites.net",
