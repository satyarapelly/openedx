// <copyright file="PXServicePmePpeNorthCentralUSSettings.cs" company="Microsoft">Copyright (c) Microsoft 2013. All rights reserved.</copyright>
...
namespace Microsoft.Commerce.Payments.PXService.Settings
{
    ...
    public class PXServicePmePpeNorthCentralUSSettings : PXServiceProdSettings
    {
        ...
        public PXServicePmePpeNorthCentralUSSettings() : base()
        {
            ...
            this.CatalogServiceAccessor = new CatalogServiceAccessor(
                serviceBaseUrl: "https://px-pxdependencyemulators-ppe-northcentralus.azurewebsites.net",
                emulatorBaseUrl: "https://px-pxdependencyemulators-ppe-northcentralus.azurewebsites.net",
