// <copyright file="SetupProviderSessionIncomingPayload.cs" company="Microsoft">Copyright (c) Microsoft. All rights reserved.</copyright>

namespace Microsoft.Commerce.Payments.PXService.Model.WalletService
{
    using Newtonsoft.Json;

    public class SetupProviderSessionIncomingPayload
    {
