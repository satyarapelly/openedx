...
namespace Microsoft.Commerce.Payments.Common.OpenTelemetry
{
    public class SllEtwLogger : IQosLogger
    {
        ...
        {
            SllLogger.TraceMessage(message, eventLevel.ToEventLevel(), correlationId, trackingGuid);
        }
        ...
        {
            SllLogger.TraceServiceLoggingOutgoing(dependencyServiceName, operationName, operationVersion, remoteAddress, protocol, wfcRequest, wfcResponse, requestPayload, responsePayload, latencyMs, requestTraceId, serverTraceId, message, flightingExperimentId, serviceRequestStatus);
        }
